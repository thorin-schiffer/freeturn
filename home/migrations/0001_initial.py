    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_in_cv',
                 models.BooleanField(default=True, help_text='Match for technology in CV relevant projects?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description',
                 wagtail.core.fields.RichTextField(help_text='Long description to show on the detail page')),
                ...
                ('logo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                           related_name='+', to='wagtailimages.Image')),
                ('reference_letter',
                 models.ForeignKey(blank=True, help_text='Reference letter for this project', null=True,
                                   on_delete=django.db.models.deletion.SET_NULL, related_name='+',
                                   to='wagtaildocs.Document')),
                ('responsibilities', modelcluster.fields.ParentalManyToManyField(blank=True, related_name='projects',
                                                                                 to='home.Responsibility')),
                ('technologies', modelcluster.fields.ParentalManyToManyField(blank=True, related_name='projects',
                                                                             to='home.Technology')),
            ],
            options={
                'ordering': ('-start_date',),
            ...
            fields=[
                ('page_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='wagtailcore.Page')),
                ('claim',
                 models.CharField(default='Freelance python developer', help_text='Claim text placed under the name',
                                  max_length=300)),
                ('title_color', models.CharField(default='#FFFFFF', max_length=10)),
                ('earliest_available', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('background', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                 related_name='+', to='wagtailimages.Image')),
                ('picture', models.ForeignKey(blank=True, help_text='My picture', null=True,
                                              on_delete=django.db.models.deletion.SET_NULL, related_name='+',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE,
                                                         related_name='form_fields', to='home.ContactPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
